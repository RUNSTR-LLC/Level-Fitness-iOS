...
class TeamsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("🏗️ LevelFitness: Loading Teams page...")
    ...
    @objc private func backButtonTapped() {
        print("🏗️ LevelFitness: Teams back button tapped")
        navigationController?.popViewController(animated: true)
        print("🏗️ LevelFitness: Successfully navigated back to main dashboard")
    }
...
extension TeamsViewController: TeamCardDelegate {
    func teamCardDidTap(_ teamCard: TeamCard, teamData: TeamData) {
        print("🏗️ LevelFitness: Navigating to team detail for \(teamData.name)")
