...
class WorkoutStatsView: UIView {
    ...
    func loadRealData() {
        // Show empty state until real data loads from HealthKit
        showEmptyState()
    }
    ...
    func updateWithHealthKitWorkouts(_ workouts: [HealthKitWorkout]) {
        print("🏃‍♂️ RunstrRewards: Updating stats view with \(workouts.count) HealthKit workouts")
    ...
    private func mapWorkoutType(_ workoutType: String) -> WorkoutType {
        ...
        case "hiit", "high_intensity_interval_training": return .hiit
        ...
        case "core_training", "stretching": return .other
        case "martial_arts": return .other
        case "elliptical", "stairs": return .other
    ...
    @objc private func periodButtonTapped(_ sender: UIButton) {
        ...
        print("🏃‍♂️ RunstrRewards: Stats period selected: \(selectedPeriod.title)")
    }
