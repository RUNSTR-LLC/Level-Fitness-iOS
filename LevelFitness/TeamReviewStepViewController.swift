...
class TeamReviewStepViewController: UIViewController {
    ...
    private func setupReviewSections() {
        ...
        finalNotesSection.layer.borderColor = UIColor(red: 0.2, green: 0.8, blue: 0.2, alpha: 0.5).cgColor // Green border
    }
    ...
    private func populateReviewData() {
        ...
        let finalNotesContent = createReviewSection(
            ...
            highlightColor: UIColor(red: 0.2, green: 0.8, blue: 0.2, alpha: 1.0)
        )
