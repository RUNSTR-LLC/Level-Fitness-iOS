...
class CompetitionTabNavigationView: UIView {
    ...
    private func setupTabButtons() {
        ...
        for tab in tabs {
            ...
            print("🏆 RunstrRewards: Created tab button for \(tab.title) with tag \(button.tag)")
    ...
    private func setupConstraints() {
        ...
        print("🏆 RunstrRewards: Tab navigation constraints configured with improved spacing")
    }
    ...
    func selectTab(_ tab: CompetitionTab) {
        print("🏆 RunstrRewards: selectTab called with: \(tab.title), current was: \(currentTab.title)")
        currentTab = tab
        print("🏆 RunstrRewards: currentTab updated to: \(currentTab.title)")
        updateTabAppearance()
    ...
    @objc private func directTabTapped(_ gesture: UITapGestureRecognizer) {
        ...
        print("🏆 RunstrRewards: Direct tap gesture detected on button with tag: \(button.tag)")
    ...
    @objc private func tabButtonTapped(_ sender: UIButton) {
        ...
        print("🏆 RunstrRewards: === TAB BUTTON TAPPED ===")
        print("🏆 RunstrRewards: Button frame: \(sender.frame)")
        print("🏆 RunstrRewards: Button tag: \(sender.tag)")
        print("🏆 RunstrRewards: Selected tab: \(selectedTab.title)")
        print("🏆 RunstrRewards: Current tab: \(currentTab.title)")
        print("🏆 RunstrRewards: Delegate exists: \(delegate != nil)")
        ...
        print("🏆 RunstrRewards: Calling selectTab(\(selectedTab.title))...")
        selectTab(selectedTab)
        
        print("🏆 RunstrRewards: Calling delegate.didSelectTab(\(selectedTab.title))...")
        delegate?.didSelectTab(selectedTab)
        
        print("🏆 RunstrRewards: Tab selection completed for: \(selectedTab.title)")
        print("🏆 RunstrRewards: ========================")
    }
    ...
    override func hitTest(_ point: CGPoint, with event: UIEvent?) -> UIView? {
        ...
        for (tab, button) in tabButtons {
            ...
            if expandedFrame.contains(buttonPoint) {
                print("🏆 RunstrRewards: Hit test detected touch on \(tab.title) button")
                return button
            }
        }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if let touch = touches.first {
            ...
            print("🏆 RunstrRewards: TabNavigation touch detected at location: \(location)")
            print("🏆 RunstrRewards: TabNavigation bounds: \(bounds)")
            
            // Check which button might be touched
            for (tab, button) in tabButtons {
                let buttonFrame = button.frame
                print("🏆 RunstrRewards: \(tab.title) button frame: \(buttonFrame)")
                if buttonFrame.contains(location) {
                    print("🏆 RunstrRewards: Touch is over \(tab.title) button!")
                }
            }
        }
    }
