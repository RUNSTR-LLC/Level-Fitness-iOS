...
// Use the real TeamWalletPaymentService from Wallet services

class TeamWalletViewControllerNew: UIViewController {
...
extension TeamWalletViewControllerNew: TeamWalletDataDelegate {
...
extension TeamWalletViewControllerNew: TeamWalletPaymentDelegate {
    ...
    func didGenerateInvoice(_ invoice: LightningInvoice) {
        print("Generated invoice: \(invoice.paymentRequest)")
    }
}