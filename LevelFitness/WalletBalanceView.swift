...
class WalletBalanceView: UIView {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            // Bitcoin symbol
            bitcoinSymbolLabel.leadingAnchor.constraint(equalTo: balanceAmountContainer.leadingAnchor),
            bitcoinSymbolLabel.centerYAnchor.constraint(equalTo: balanceAmountContainer.centerYAnchor),
            
            // Balance value
            balanceValueLabel.leadingAnchor.constraint(equalTo: bitcoinSymbolLabel.trailingAnchor, constant: 8),
            balanceValueLabel.trailingAnchor.constraint(equalTo: balanceAmountContainer.trailingAnchor),
            balanceValueLabel.centerYAnchor.constraint(equalTo: balanceAmountContainer.centerYAnchor),
    ...
    func configure(with data: WalletData) {
        balanceValueLabel.text = String(format: "%.4f", data.bitcoinBalance)
