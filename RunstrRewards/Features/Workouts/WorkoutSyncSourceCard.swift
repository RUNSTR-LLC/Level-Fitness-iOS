...
class WorkoutSyncSourceCard: UIView {
    ...
    private func setupCard() {
        ...
        toggleSwitch.backgroundColor = UIColor(red: 0.1, green: 0.1, blue: 0.1, alpha: 1.0)
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            infoContainer.trailingAnchor.constraint(lessThanOrEqualTo: toggleSwitch.leadingAnchor, constant: -12),
            ...
            // Bolt decoration
            boltDecoration.topAnchor.constraint(equalTo: containerView.topAnchor, constant: 8),
            boltDecoration.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -8),
    ...
    private func configureWithData() {
        ...
        // Configure toggle switch based on source state
        if sourceData.isComingSoon {
            toggleSwitch.isEnabled = false
            toggleSwitch.isOn = false
            toggleSwitch.alpha = 0.5
        } else {
            toggleSwitch.isEnabled = true
            toggleSwitch.isOn = sourceData.isConnected
    ...
    @objc private func toggleSwitched(_ sender: UISwitch) {
        print("🏃‍♂️ RunstrRewards: Toggle switched for \(sourceData.type.displayName): \(sender.isOn)")
        delegate?.didToggleAutoSync(sourceData, enabled: sender.isOn)
    }
    ...
    @objc private func cardTapped() {
        ...
        if sourceData.isComingSoon {
            ...
            print("🏃‍♂️ RunstrRewards: Coming soon source tapped: \(sourceData.type.displayName)")
            return
        }
        ...
        print("🏃‍♂️ RunstrRewards: Sync source tapped: \(sourceData.type.displayName)")
    }
